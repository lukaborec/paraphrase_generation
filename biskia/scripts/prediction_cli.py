...
def predict(experiment_name, split_name, config_directory_path, checkpoint_dir, dataset_dir, dataset_file_path,
            comet_user):
    """
    ...
    perform_prediction_series_or_single(config, split_name)
